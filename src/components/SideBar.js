  ...
  return (
            ...
            <IconContext.Provider value={{ color: '#fff' }}>
                ...
                <button to='#' className='menu-bars float-right '>
                    ...
                    <FaIcons.FaBars onClick={this.showSidebar} class="bg-transparent bars text-green-300  lg:mr-20 md:mr-10  lg:mt-5  float-right" size={40}/>
                </button>
                </div>
                <nav className={this.state.sidebar ? 'nav-menu active' : 'nav-menu'}>
                <ul className='nav-menu-items bg-slate-800/90 w-full  ' onClick={this.showSidebar}>
                    <li className='navbar-toggle'>
                    <button to='#' className='menu-bars '>
                        <AiIcons.AiOutlineClose size={40} />
                    </button>
                    </li>
