...
export default class MaterialAdvantageSideBar extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            sidebar: false,
                ...
                <ul className='nav-menu-items bg-slate-800 w-full  ' onClick={this.showSidebar}>
                    ...
                    <button to='#' className='menu-bars '>
                        ...
                        <div class="text-md bg-transparent lg:flex-grow md:flex-grow mt-5 ">
                            ...
                            <a href="/nsbe"  onClick={this.showSidebar}  smooth={true} class="bg-transparent text-xl block mt-4 p-2 rounded-md  hover:text-orange-300 hover:bg-opacity-20 hover:bg-orange-300 lg:mt-0 text-orange-100">
