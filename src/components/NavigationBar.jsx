            ...
            <nav class="flex justify-between bg-transparent   text-green-300 pb-6 flex-wrap  lg:m-30 pt-6" >
                ...
                <div class="  lg:flex text-right  bg-transparent lg:items-center lg:w-auto">
                    <div class="text-md bg-transparent lg:flex-grow">
                        <Link to="Clubs" smooth={true} class="bg-transparent text-xl block mt-4 p-2 rounded-md lg:inline-block hover:text-green-300 hover:bg-opacity-20 hover:bg-green-300 lg:mt-0 text-green-100">
                            Clubs
                        </Link>
                        <Link to="Calendar"  smooth={true} class="bg-transparent text-xl block mt-4 p-2 rounded-md lg:inline-block hover:text-green-300 hover:bg-opacity-20 hover:bg-green-300 lg:mt-0 text-green-100">
                            Calendar
                        </Link>
