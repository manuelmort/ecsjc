...
export default class DSANavBar extends React.Component {
    ...
    render() {
        return(
            ...
            <a  
                        href="/dsa" class="text-purple-300  font-semibold text-3xl bg-transparent tracking-tight 
                        hover:underline underline-offset-4  ">
                        <img src="./swelogo.png" class="h-20 hover:bg-purple-300/30 rounded-lg p-2"/></a>
                <div class="  lg:flex text-right  bg-transparent lg:items-center lg:w-auto z-10 ">
                    <div class="text-md bg-transparent lg:flex-grow z-20 ">
                        <Link onClick={this.handleDrop} smooth={true} class=" bg-transparent text-xl block mt-4 p-3 rounded-md md:inline-block lg:inline-block hover:text-emerald-300 hover:bg-opacity-20 hover:bg-emerald-700 lg:mt-0 text-indigo-100">
                            Clubs
                        ...
                        <Link  to="About Us" smooth={true}
                            class="bg-transparent text-xl block mt-4 p-2 rounded-md lg:inline-block hover:text-emerald-300 md:inline-block hover:bg-opacity-20 hover:bg-emerald-700 lg:mt-0 text-indigo-100">
                            About Us
                        </Link>
                        <a href="/" smooth={true}
                            class="bg-transparent text-xl block mt-4 p-2 rounded-md lg:inline-block hover:text-emerald-300 md:inline-block hover:bg-opacity-20 hover:bg-emerald-700 lg:mt-0 text-indigo-100">
