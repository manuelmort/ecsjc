    ...
    render() {
        return(
            ...
            <nav class="flex justify-between bg-transparent pb-6 flex-wrap   lg:m-30 pt-6" >
                    <a  
                        href="/swe" class="text-green-300 font-semibold text-3xl bg-transparent tracking-tight 
                        hover:underline underline-offset-4 ">
                        <img src="./swelogowhite.png" class="h-20 hover:bg-purple-300/30 rounded-lg p-2"/></a>
